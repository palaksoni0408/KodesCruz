            ...
            <div className="relative z-10">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
                        ...
                        <div className="flex items-center justify-between mb-16">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-2xl font-bold text-white">KodesCruz</h1>
                            </div>
                            <a
                        ...
                        <div className="text-center max-w-4xl mx-auto">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-8">
                                ...
                                <span className="text-sm text-blue-300">Powered by Groq AI - Lightning Fast Inference</span>
                            </div>

                            <h2 className="text-5xl sm:text-7xl font-bold mb-6 text-white drop-shadow-lg">
                                AI-Powered Coding Assistant
                            </h2>

                            <p className="text-xl sm:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto drop-shadow-md">
                            ...
                            <button
                                ...
                                className="group inline-flex items-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 rounded-xl text-lg font-semibold transition-all duration-200 shadow-lg shadow-blue-500/25 hover:scale-105"
                            >
                                Get Started Free
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* AI Features */}
                        <div className="group p-8 rounded-2xl bg-slate-900/50 backdrop-blur-sm border border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
                            <div className="w-12 h-12 bg-slate-800 rounded-lg flex items-center justify-center mb-4 group-hover:bg-slate-700 transition-colors">
                                <Sparkles className="w-6 h-6 text-blue-400" />
                            </div>
                            <h3 className="text-xl font-bold mb-3 text-white">AI-Powered Features</h3>
                        ...
                        <div className="group p-8 rounded-2xl bg-slate-900/50 backdrop-blur-sm border border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
                            ...
                            <h3 className="text-xl font-bold mb-3 text-white">Code Playground</h3>
                            <p className="text-gray-400 leading-relaxed">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="relative overflow-hidden rounded-3xl bg-slate-900/60 border border-slate-700 p-8 md:p-12 backdrop-blur-sm">
                            <div className="relative flex flex-col md:flex-row gap-8 items-center">
                                {/* Profile Picture */}
                                <div className="flex-shrink-0">
                                    <div className="w-40 h-40 rounded-2xl overflow-hidden ring-4 ring-blue-500/30 shadow-2xl">
                                        <img
                            ...
                            <div className="mt-8 pt-8 border-t border-slate-700/50">
                                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                                    <span className="px-3 py-1 bg-slate-800 border border-slate-600 rounded-full text-xs text-blue-200">
                                        Machine Learning
                                    </span>
                                    <span className="px-3 py-1 bg-slate-800 border border-slate-600 rounded-full text-xs text-blue-200">
                                        Data Science
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
                    <div className="relative overflow-hidden rounded-3xl bg-blue-900/40 p-12 text-center border border-blue-500/20 backdrop-blur-sm">
                        <div className="relative">
                            ...
                            <button
                                onClick={onGetStarted}
                                className="inline-flex items-center gap-3 px-8 py-4 bg-white text-blue-600 hover:bg-gray-100 rounded-xl text-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
                            >
                                Start Coding Now
